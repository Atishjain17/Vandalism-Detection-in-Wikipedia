...
users_file = pd.read_csv("vews_dataset_v1.1/vandal_2013_10.csv")
...
merged_inner1.to_csv('Editbenign1/vandal_2013_10.csv',index=False, encoding='utf-8')
...
userscrf_crv.to_csv('Editbenign_crf_crv/vandal_2013_10_crf_crv.csv',index=False, encoding='utf-8')

usersfm=users[['username1','meta1']]
usersfm=usersfm.drop_duplicates(subset='username1',keep='first')
print(usersfm.dtypes)
usersfm.to_csv('Editbenign_fm/vandal_2013_10_fm.csv',index=False, encoding='utf-8')
...
userscrmv.to_csv('Editbenign_crmv/vandal_2013_10_crmv.csv',index=False, encoding='utf-8')

userscrms=userscrm[userscrm.timedifference>timedelta(minutes=15 )]
userscrms['crms'] = 1
del userscrms['timedifference']
print(userscrms.dtypes)
userscrms.to_csv('Editbenign_crms/vandal_2013_10_crms.csv',index=False, encoding='utf-8')
...
userscrmf.to_csv('Editbenign_crmf/vandal_2013_10_crmf.csv',index=False, encoding='utf-8')
...
userscrnv.to_csv('Editbenign_crnv/vandal_2013_10_crnv.csv',index=False, encoding='utf-8')

userscrns=userscrn[userscrn.timedifference>timedelta(minutes=15 )]
userscrns['crns'] = 1
del userscrns['timedifference']
print(userscrns.dtypes)
userscrns.to_csv('Editbenign_crns/vandal_2013_10_crns.csv',index=False, encoding='utf-8')
...
userscrnf.to_csv('Editbenign_crnf/vandal_2013_10_crnf.csv',index=False, encoding='utf-8')
...
userscrncount.to_csv('Editbenign_crncount/vandal_2013_10_crncount.csv', encoding='utf-8')
...
userscrmcount.to_csv('Editbenign_crmcount/vandal_2013_10_crmcount.csv', encoding='utf-8')
...
print(userscount.head(10))
userscount.to_csv('Editbenign_total/vandal_2013_10_totaledit.csv', encoding='utf-8')
