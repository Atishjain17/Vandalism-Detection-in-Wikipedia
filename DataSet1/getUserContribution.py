...
Pipeline:
Get (blocked) user
Get contribution by the user
Get whether the contribution was reverted any time
Get path to the next contribution -  Get metadata about the page pair (category, semantic category)
    ...
    for user in users:
        ...
        while True:
            ...
            for contrib in contribs:
                ...
                print(user["user"], "\t", user["timestamp"], "\t", contrib["title"], "\t", ts, "\t", revertededit, "\t",
                      revertedtime)
