...
benign=pd.read_csv('Editbenign2/benign_2013_2_1_crs.csv')
#vandal=pd.read_csv('Editbenign2/vandal_2013_2_1_crs1.csv')

fm=pd.read_csv('Editbenign_fm/benign_2013_2_1_fm.csv')
nts=pd.read_csv('Editbenign_nts_nts/benign_2013_2_1_nts.csv')
crmcount=pd.read_csv('Editbenign_crmcount/benign_2013_2_1_crmcount.csv')
crncount=pd.read_csv('Editbenign_crncount/benign_2013_2_1_crncount.csv')
total=pd.read_csv('Editbenign_total/benign_2013_2_1_totaledit.csv')
...
merged5['vandal']=0
merged5.to_csv('Editbenign3/benign_2013_2_1.csv',index=False, encoding='utf-8')